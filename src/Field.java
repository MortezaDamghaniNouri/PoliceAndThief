public class Field {
    ...
    public int[][] fieldMaker(Thief t, Police polices[], int n) {
        ...
        for (int i = 0; i < n; ++i) {
            if (gameTable[polices[i].getRow()][polices[i].getColumn()] == 1 || gameTable[polices[i].getRow()][polices[i].getColumn()] == 12) {
                gameTable[polices[i].getRow()][polices[i].getColumn()] = 12;
            }
            if (gameTable[polices[i].getRow()][polices[i].getColumn()] == 2 || gameTable[polices[i].getRow()][polices[i].getColumn()] == 0) {
